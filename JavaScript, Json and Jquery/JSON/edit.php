...
<html>
<head>
    <title>Indrasena Kalyanam</title>
...
<form>
    <div class="container">
        ...
        <form method="post">
            <p>First Name:
                <input type="text" name="first_name" size="60" value="<?php echo $profile['first_name'] ?>" required/></p>
            <p>Last Name:
                <input type="text" name="last_name" size="60" value="<?php echo $profile['last_name'] ?>" required/></p>
            <p>Email:
                <input type="text" name="email" size="30" value="<?php echo $profile['email'] ?>" required/></p>
            <p>Headline:<br/>
                <input type="text" name="headline" size="80" value="<?php echo $profile['headline'] ?>" required/></p>
            <p>Summary:<br/>
                <textarea name="summary" rows="8" cols="80" required><?php echo $profile['summary'] ?></textarea>
                <?php
